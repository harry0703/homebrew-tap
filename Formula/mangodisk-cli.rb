class MangodiskCli < Formula
  ...
  url "https://github.com/harry0703/MangoDisk/releases/download/v1.1.0/MangoDisk-1.1.0-macos-cli.tar.gz"
  sha256 "041b3221b106766f33509027a0108a177652623fa7ef8329a5138d2eae98b4e9"
